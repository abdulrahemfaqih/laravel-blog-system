            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    {{-- <img class="h-8 w-8" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500"
                        alt="Your Company"> --}}
                    <h1 class="text-white text-2xl">K2</h1>
                </div>
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none" id="user-menu-button"
                                aria-expanded="false" aria-haspopup="true">
                                {{-- <span class="absolute -inset-1.5"></span> --}}
                                <p class="text-slate-100 ">{{ auth()->user()->name }}</p>
                                <span class="sr-only">Open user menu</span>
                                <svg class="h-5 w-5 ml-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            <a href="/logout" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                            <a href="/" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Keluar Dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
